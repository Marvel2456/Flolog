...
class Chatroom(models.Model):
    ...
    med_history = models.ForeignKey(MedicalHistory, on_delete=models.CASCADE, blank=True, null=True)
    allergy = models.ForeignKey(PatientAllergy, on_delete=models.CASCADE, blank=True, null=True)
    fam_history = models.ForeignKey(FamilyHistory, on_delete=models.CASCADE, blank=True, null=True)
