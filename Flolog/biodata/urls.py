...
urlpatterns = [
    ...
    path("record_detail/", MedicalRecordDetailView.as_view(), name="record_detail"),
    path("patient_history/", MedicalHistoryView.as_view(), name="patient_history"),
    path("history_detail/", MedicalHistoryDetailView.as_view(), name="history_detail"),
    path("pateint_allergy/", PatientAllergyView.as_view(), name="patient_allergy"),
    path("allergy_detail/", AllergyDetailView.as_view(), name="allergy_detail"),
    path("family/", FamilyHistoryView.as_view(), name="family"),
    path("family_detail/", FamilyHistoryDetailView.as_view(), name="family_detail"),
